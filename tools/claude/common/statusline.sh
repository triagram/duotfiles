...
cwd=""; model=""; cost=0; pct=0; in_tok=0; out_tok=0; win=0; effort=""
_i=0
...
# Effort rides along inside $model so every downstream user picks it up: the
# single render site and, more importantly, the plain-text copy the width
# calculation measures. Appending it anywhere later would make the line wider
# than the fitting logic believes it to be.
